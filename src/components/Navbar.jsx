      ...
      <div>
        {
            user ? 
             <div className='flex items-center gap-2 sm:gap-5'>
                <button onClick={()=>navigate('/buy')} className=' flex items-center px-5 py-2 sm:px-7 sm:py-3  rounded-full hover:scale-105  transition-all duration-500 bg-green-500'>
